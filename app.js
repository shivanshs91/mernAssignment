...
// Connect to MongoDB
const MongoDB_USERID = process.env.MONGODB_USERID;
const MONGODB_PASSWORD = process.env.MONGODB_PASSWORD;
const MONGODB_DATABASE = process.env.MONGODB_DATABASE;
const MONGODBURI = `mongodb+srv://${MongoDB_USERID}:${MONGODB_PASSWORD}@cluster0.9o6eros.mongodb.net/${MONGODB_DATABASE}?retryWrites=true&w=majority`;
